                    ...
                    <form action="{{route('equipe.store')}}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group mb-3">
                                ...
                                <input class="form-control form-control-rounded" id="lastName2" type="text" name="poste" value="{{old('poste')}}" required placeholder="Entrer le poste" />
                            </div>
                            <div class="col-md-6 form-group mb-3">
                            ...
                            <div class="col-md-6 form-group mb-3">
                                ...
                                <input class="form-control form-control-rounded" id="website2" placeholder="Une description" name="description" value="{{old('description')}}" />
                            </div>
                            <div class="col-md-6 form-group mb-3">
