                                ...
                                <table class="table text-center" id="user_table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <th scope="row">1</th>
                                            <td>Smith Doe</td>
                                            <td><img class="rounded-circle m-0 avatar-sm-table" src="{{asset('backend/assets/dist-assets/images/faces/1.jpg')}}" alt="" /></td>
        ...
        <div class="col-lg-6 col-md-12">
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <div class="d-flex flex-column flex-sm-row align-items-sm-center mb-3"><img class="avatar-lg mb-3 mb-sm-0 rounded mr-sm-3" src="{{asset('backend/assets/dist-assets/images/products/headphone-4.jpg')}}" alt="" />
                    ...
                    <div class="d-flex flex-column flex-sm-row align-items-sm-center mb-3"><img class="avatar-lg mb-3 mb-sm-0 rounded mr-sm-3" src="{{asset('backend/assets/dist-assets/images/products/headphone-2.jpg')}}" alt="" />
                        <div class="flex-grow-1">
                    ...
                    <div class="d-flex flex-column flex-sm-row align-items-sm-center mb-3"><img class="avatar-lg mb-3 mb-sm-0 rounded mr-sm-3" src="{{asset('backend/assets/dist-assets/images/products/headphone-3.jpg')}}" alt="" />
                        <div class="flex-grow-1">
    ...
    {{-- <div class="app-footer">
        ...
        <div class="footer-bottom border-top pt-3 d-flex flex-column flex-sm-row align-items-center">
            ...
            <div class="d-flex align-items-center">
                <img class="logo" src="{{asset('backend/assets/dist-assets/images/logo.png')}}" alt="">
                <div>
