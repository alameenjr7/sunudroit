    ...
    <div class="logo">
        <img src="{{asset('backend/assets/dist-assets/images/logo.png')}}" alt="">
    </div>
    ...
    <div class="header-part-right">
        ...
        <div class="dropdown">
            <div class="user col align-self-end">
                <img src="{{asset('backend/assets/dist-assets/images/faces/1.jpg')}}" id="userDropdown" alt="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
