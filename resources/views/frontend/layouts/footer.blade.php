    ...
    <div class="auto-container">
        <div class="inner-container">
            ...
            <div class="content">
                ...
                <a href="tel:+{{get_setting('telephone1')}}" class="theme-btn btn-style-two"><span class="txt"><i class="arrow flaticon-right"></i></span></a>
            </div>
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="footer-column col-lg-4 col-md-6 col-sm-12">
                                    <div class="footer-widget logo-widget">
                                        <div class="logo" >
                                            <a href="{{route('home')}}"><img src="{{asset(get_setting('favicon2'))}}" alt="" style="width: 50%; height: 50%;"/></a>
                                        </div>
